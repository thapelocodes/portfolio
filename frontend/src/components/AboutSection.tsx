  ...
  return (
    ...
    >
      ...
      <div className="lg:flex flex-row-reverse items-center">
        <div className="profile max-w-xs lg:w-80 mx-auto my-10 self-end"></div>
        <div className="flex flex-col lg:items-start lg:max-w-xs mx-auto lg:self-center">
          ...
          <button className="text-tertiary text-sm w-full sm:w-7/12 mx-auto lg:mx-0 lg:w-full font-medium py-2 shadow px-4 border border-tech-blue hover:bg-tech-blue/10 text-foreground px-6 py-3 rounded-lg font-medium transition-all duration-300">
