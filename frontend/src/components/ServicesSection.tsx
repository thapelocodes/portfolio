  ...
  return (
    <section className="services w-full rounded-2xl my-2 md:max-w-screen-sm mx-auto py-2 px-3 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row justify-between-2 md:whitespace-nowrap scrollContainer">
        <div className="w-fit my-1 mx-auto md:mx-1 rounded-xl bg-gradient-to-tl from-slate-500 dark:from-slate-700 p-1">
        ...
        <div className="w-fit mt-1 mb-2 mx-auto md:mx-1 rounded-xl bg-gradient-to-tl from-slate-500 dark:from-slate-700 p-1">
      ...
      <div className="w-fit mx-auto bg-gradient-to-br from-blue-200 to-slate-500 dark:from-blue-950 dark:to-slate-900 dark:hover:from-blue-900 dark:hover:to-slate-800 rounded-xl my-1 py-2 px-4">
