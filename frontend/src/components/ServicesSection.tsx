...
const ServicesSection = () => {
  ...
  return (
    <section className="services w-full rounded-2xl my-8 md:max-w-screen-sm mx-auto py-8 px-3 overflow-hidden">
      <h2 className="text-shadow text-tertiary text-2xl mb-5">
        Services & Skills
      </h2>
      <ul className="flex flex-col md:flex-row md:whitespace-nowrap sliderContainer gap-8 md:gap-4 my-8 py-8">
