...
const Header = () => {
  ...
  return (
    <header className="bg-gray-800 text-white py-2 flex fixed w-full">
      <div className="container mx-8 flex justify-between items-center">
        ...
        <div className="flex flex-col">
          ...
          <button
            onClick={handleClick}
            className="md:hidden flex flex-col justify-center items-center w-8 h-8 mx-auto border border-slate-400 rounded"
          >
            <span
              className={`block w-9/12 h-0.5 bg-slate-400 transform transition duration-200 ease-in-out ${
                openMenu ? "rotate-45 translate-y-1.5" : ""
              }`}
            ></span>
            <span
              className={`block w-9/12 h-0.5 bg-slate-400 transition duration-200 ease-in-out my-1 ${
                openMenu ? "opacity-0" : ""
              }`}
            ></span>
            <span
