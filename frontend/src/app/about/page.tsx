      ...
      <div className="md:flex flex-row-reverse items-center">
        ...
        <div className="md:flex flex-col md:items-start md:max-w-xs mx-auto md:self-center p-3">
          ...
          <p className="my-3 text-justify mx-6 md:ml-0 md:mr-5">
            I am a self-taught developer and I recently obtained my
            certification from ALX with a plethora of technical and soft skills.
            I have a passion for coding creative user interfaces and solving
            complex problems. As a full-stack developer and frontend specialist
            it is guaranteed that adding me to your team will prove to be a
            valuable investment. See my resume and certification below.
          </p>
